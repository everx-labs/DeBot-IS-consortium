...
returns:
    ...
    legalNotes: Note[] - optional, list of legal notes. Every note is a pair of name and link.
...
```js
    ...
    abstract contract Debot {
        ...
        function getDebotInfo() virtual returns (string dabi, string name, string version, string publisher, string caption, string author, address support, string hello, string language, string icon);
    }
    ...
    contract DebotA is Debot {
        ...
        function getDebotInfo() override returns (string dabi, string name, string version, string publisher, string caption, string author, address support, string hello, string language, string icon) {
            dabi = m_debotAbi.get();
            name = "Depool Debot";
            version = "0.1.0";
            publisher = "TON Labs";
